...
public class CacheUtil {
    ...
    public static boolean setString(String key, String value) {
        ...
        try {
            if (checkBeforeInvoke(key,value)) {
                return false;
            }
            key = buildKey(key);
    ...
    public static boolean checkBeforeInvoke(String key, String value) {
        return isClose() || isEmpty(key) || isEmpty(value);
    }
}